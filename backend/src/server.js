    ...
    const folders = (Array.isArray(series) ? series : [])
      .map((item) => {
        ...
        return {
          ...
          group,
          category: group,
          logoUrl: magmaSeriesImageUrl(item.cover || item.stream_icon || item.pic || item.icon || (item.info && item.info.cover) || item.pic || item.icon || (item.info && item.info.cover) || "", "w500"),
          posterUrl: magmaSeriesImageUrl(item.cover || item.stream_icon || item.pic || item.icon || (item.info && item.info.cover) || item.pic || item.icon || (item.info && item.info.cover) || "", "w500"),
  ...
  try {
    ...
    const items = series
      ...
      .map((item) => {
        ...
        const poster = magmaDynamicSearchImage(item.cover || item.stream_icon || item.pic || item.icon || (item.info && item.info.cover) || item.pic || item.icon || (item.info && item.info.cover) || item.poster_path, "w500");
